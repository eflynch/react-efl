...
function XYPad(props) {
    ...
    var _a = react.exports.useState("idle"), dragging = _a[0], setDragging = _a[1];
    var _b = react.exports.useState(null), relativePosition = _b[0], setRelativePosition = _b[1];
    var circleRef = react.exports.useRef(null);
    var rectRef = react.exports.useRef(null);
    var circlePosition = {
        x: props.position.x - circleRadius / 2,
        y: props.position.y - circleRadius / 2
    };
    var onMouseDown = react.exports.useCallback(function (e) {
    ...
    var onMouseMove = react.exports.useCallback(function (e) {
        if (dragging == "idle") {
            return;
        }
        if (dragging == "snap") {
    ...
    var onMouseUp = react.exports.useCallback(function (e) {
        setDragging("idle");
        e.stopPropagation();
        e.preventDefault();
    }, []);
